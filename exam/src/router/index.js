...
export default new Router({
  routes: [
    ...
    },
    {
        path: '/',
        name: 'garbage',//首页
        component: () => import('@/components/common/garbage')
    },
    {
      path: '/hazardousName',
      name: 'garbage',//查找垃圾种类
    ...
    {
      path: '/toshowrecyclable',
      name: 'showrecyclable',
      component: () => import('@/components/garbage/showrecyclable')
    },,
    {
      path: '/toshowhazardous',
      name: 'showrecyclable',
      component: () => import('@/components/garbage/showhazardous')
    },
    {
      path: '/toshowhousehold',
      name: 'showrecyclable',
      component: () => import('@/components/garbage/showhousehold')
    },
    {
      path: '/toshowresidual',
      name: 'showrecyclable',
      component: () => import('@/components/garbage/showresidual')
    },
    // {
    //   path: '/recyclable',
    //   name: 'showgarbage',
    //   component: () => import('@/components/garbage/showgarbage')
    // },
    {
      path: '/index', //教师主页
