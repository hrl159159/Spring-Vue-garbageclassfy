        ...
        <div class="bg">
          <div class="all">
            <header id="topbar">
              ...
              <el-table :data="pagination.records" align="center" class="table">
                  <el-table-column   prop="id" label="序号" width="80"></el-table-column>
                <el-table-column  prop="recname" label="垃圾名称" width="250"></el-table-column>
              </el-table>
...
export default {
  ...
  methods: {
    getAnswerInfo() {
      this.$axios(`/api/recyclable/${this.pagination.current}/${this.pagination.size}`).then(res => {
